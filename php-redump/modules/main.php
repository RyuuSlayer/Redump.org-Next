...
<div class="textblock"><div class="textinfo">Posted by <a href="http://forum.'.$_SERVER['HTTP_HOST'].'/profile.php?id='.$news['poster_id'].'">'.htmlspecialchars($news['poster']).'</a> at '.format_datetime($news['posted'], 'F j Y, H:i:s').'</div>'.parse_message($news['message']);
